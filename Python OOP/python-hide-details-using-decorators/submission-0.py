class SuperHero:
    ...
    def health(self, new_health: int) -> None:
        if new_health > 100:
            return print("You can't set the health to more than 100")
        elif new_health < 0:
            return print("You can't set the health to less than 0")
        else:
    ...
    def power_level(self, new_power_level: int) -> None:
        if new_power_level > 10:
            return print("You can't set the power level to more than 10")
        elif new_power_level < 1:
            return print("You can't set the power level to less than 1")
        else:
